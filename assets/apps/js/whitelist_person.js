$(document).ready(function () {
  var dataTable = $("#table_data").DataTable({
    ...
    pageLength: 50,
    ajax: {
      url: site_url + "/whitelist_person/fetch_whitelist_person",
      data: {
...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/whitelist_person/del_whitelist_person",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/whitelist_person/save_whitelist_person",
      params = {
        items: items,
      };
  ...
  save_org: function (items, cb) {
    var url = "/whitelist_person/save_org",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/whitelist_person/get_whitelist_person",
      params = {
        id: id,
      };
  ...
  get_person_by_cid: function (cid, cb) {
    var url = "/whitelist_person/get_person_by_cid",
      params = {
        cid: cid,
      };
...
crud.save = function (items, row_id) {
  crud.ajax.save(items, function (err, data) {
    if (err) {
      ...
      //window.location = site_url + "/whitelist_person/add_whitelist";
    }
  });
};
