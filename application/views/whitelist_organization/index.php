...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> รายชื่อตามองค์กร
        ...
        <div class="panel-body">
            ...
            <table id="table_data" class="table table-responsive">
                <thead>
                <tr>
                    <th>ID</th><th>หน่วยงาน</th><th>เลขบัตรประชาชน</th><th>คำนำหน้า</th><th>ชื่อ</th><th>นามสกุล</th><th>เพศ</th><th>วันเกิด</th><th>เบอร์โทร</th>
                    <th>#</th>
                </tr>
                </thead>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="organization" placeholder="หน่วยงาน" value=""></div><div class="form-group">
                    <label for="target_type">กลุ่มเป้าหมาย</label>
                    <input type="text" class="form-control" id="target_type" placeholder="กลุ่มเป้าหมาย" value=""></div><div class="form-group">
                    <label for="prov">จังหวัด</label>
                    <input type="text" class="form-control" id="prov" placeholder="จังหวัด" value=""></div><div class="form-group">
                    <label for="amp">อำเภอ</label>
                    <input type="text" class="form-control" id="amp" placeholder="อำเภอ" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="hospname" placeholder="สถานที่ฉีดวัคซีน" value=""></div><div class="form-group">
                    <label for="hospcode">รหัสหน่วยฉีดวัคซีน</label>
                    <input type="text" class="form-control" id="hospcode" placeholder="รหัสหน่วยฉีดวัคซีน" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lname" placeholder="นามสกุล" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="birth" placeholder="วันเกิด" value=""></div><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="vaccine" placeholder="รับวัคซีน" value=""></div>
      </div>
